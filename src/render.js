export default function renderTodo(todo)
{
    ...
    todo_checkbox_container.id = "todo_checkbox_container";

    const todo_checkbox = document.createElement("input");
    todo_checkbox.type = "checkbox";
    todo_checkbox.id = "todo_checkbox";
    ...
    todo_main_container.id = "todo_main_container";

    const todo_content_container = document.createElement("div");
    todo_content_container.id = "todo_content_container";
    ...
    todo_icons_container.id = "todo_icons_container";

    const todo_edit_icon = document.createElement("div");
    todo_edit_icon.id = "todo_delete_icon"
    ...
    todo_delete_icon.id = "todo_delete_icon";
    ...
    todo_expand_icon.id = "todo_expand_icon";
